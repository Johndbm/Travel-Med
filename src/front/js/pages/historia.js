        ...
        <div className="container d-flex justify-content-center">
          <form className="row g-3" onSubmit={historia}>
            ...
            <div className="col-md-3">
              ...
              <div className="input-group">
                <input
                  ...
                  required
                  onChange={(event) => setPaisRes(event.target.value)}
                  value={paisRes}
                />
              </div>
            </div>
            ...
            <h5 className="d-flex justify-content-center">
              Se ha realizado cirugias anteriormente?
            </h5>
            <div
              className=""
              value={cirugiasAnt}
              onChange={(event) => setCirugiasAnt(event.target.value)}
            >
            ...
            <div
              className="col-md-11 row d-flex justify-content-center"
              value={especif}
              onChange={(event) => setEspecif(event.target.value)}
            >
            ...
            <div className="container">
              ...
              <div
                className="col-md-11 row d-flex justify-content-center"
                onChange={(event) => setEspecify(event.target.value)}
                value={especify}
              >
                <label for="exampleFormControlTextarea2" className="form-label">
                  Si su repuesta es "SI" por favor especifique
                </label>
                <textarea
                  className="form-control"
