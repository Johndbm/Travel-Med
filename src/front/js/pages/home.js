        ...
        <p>
          <div className=" container-sm d-flex align-items-start containersn ">
            <div>
              ...
              <h4 className="px-4">
                Somos una empresa encargada de administrarte todas las
                facilidades necesarias para que puedas realizarte una operacion
                estetica en Venezuela junto a los mejores especialistas del
                pais. Nunca te dejaremos solo en este proceso.
              </h4>
            </div>
          ...
          <div className="d-flex flex-row bd-highlight mb-3 d-flex justify-content-center" id="ofrecemos">
            <div className="card">
              <img
